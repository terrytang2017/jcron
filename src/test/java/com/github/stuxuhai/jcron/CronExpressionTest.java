...
public class CronExpressionTest {
    ...
    public void checkDayOfWeekNumber() {
        assertEquals(new CronExpression("0 0 0 ? * 2").getTimeAfter(new DateTime(2012, 4, 1, 00, 00)), new DateTime(2012, 4, 2, 00, 00));
        assertEquals(new CronExpression("0 0 0 ? * 2").getTimeAfter(new DateTime(2012, 4, 4, 00, 00)), new DateTime(2012, 4, 9, 00, 00));
        assertEquals(new CronExpression("0 0 0 ? * 2").getTimeAfter(new DateTime(2012, 4, 12, 00, 00)), new DateTime(2012, 4, 16, 00, 00));
        assertEquals(new CronExpression("0 0 0 ? * 2").getTimeAfter(new DateTime(2012, 4, 18, 00, 00)), new DateTime(2012, 4, 23, 00, 00));
    }

    @Test
    public void checkDayOfWeekIncrement() {
        assertEquals(new CronExpression("0 0 0 ? * 4/2").getTimeAfter(new DateTime(2012, 4, 1, 00, 00)), new DateTime(2012, 4, 4, 00, 00));
        assertEquals(new CronExpression("0 0 0 ? * 2/2").getTimeAfter(new DateTime(2012, 4, 4, 00, 00)), new DateTime(2012, 4, 6, 00, 00));
        assertEquals(new CronExpression("0 0 0 ? * 2/2").getTimeAfter(new DateTime(2012, 4, 6, 00, 00)), new DateTime(2012, 4, 9, 00, 00));
        assertEquals(new CronExpression("0 0 0 ? * 2/2").getTimeAfter(new DateTime(2012, 4, 8, 00, 00)), new DateTime(2012, 4, 9, 00, 00));
    }

    @Test
    public void checkDayOfWeekList() {
        assertEquals(new CronExpression("0 0 0 ? * 2,6,1").getTimeAfter(new DateTime(2012, 4, 1, 00, 00)), new DateTime(2012, 4, 2, 00, 00));
        assertEquals(new CronExpression("0 0 0 ? * 2,6,1").getTimeAfter(new DateTime(2012, 4, 2, 00, 00)), new DateTime(2012, 4, 6, 00, 00));
        assertEquals(new CronExpression("0 0 0 ? * 2,6,1").getTimeAfter(new DateTime(2012, 4, 6, 00, 00)), new DateTime(2012, 4, 8, 00, 00));
    }

    @Test
    public void checkDayOfWeekLastFridayInMonth() {
        assertEquals(new CronExpression("0 0 0 ? * 6L").getTimeAfter(new DateTime(2012, 4, 1, 00, 00)), new DateTime(2012, 4, 27, 00, 00));
        assertEquals(new CronExpression("0 0 0 ? * 6L").getTimeAfter(new DateTime(2012, 4, 27, 00, 00)), new DateTime(2012, 5, 25, 00, 00));
        assertEquals(new CronExpression("0 0 0 ? * 6L").getTimeAfter(new DateTime(2012, 2, 6, 00, 00)), new DateTime(2012, 2, 24, 00, 00));
    }
    ...
    public void checkDayOfWeekShallInterpret7asSunday() {
        assertEquals(new CronExpression("0 0 0 ? * 1").getTimeAfter(new DateTime(2012, 4, 1, 00, 00)), new DateTime(2012, 4, 8, 00, 00));
        assertEquals(new CronExpression("0 0 0 ? * 6L").getTimeAfter(new DateTime(2012, 4, 1, 00, 00)), new DateTime(2012, 4, 27, 00, 00));
        assertEquals(new CronExpression("0 0 0 ? * 6#2").getTimeAfter(new DateTime(2012, 4, 1, 00, 00)), new DateTime(2012, 4, 13, 00, 00));
    }

    @Test
    public void checkDayOfWeekNthFridayInMonth() {
        assertEquals(new CronExpression("0 0 0 ? * 6#3").getTimeAfter(new DateTime(2012, 4, 1, 00, 00)), new DateTime(2012, 4, 20, 00, 00));
        assertEquals(new CronExpression("0 0 0 ? * 6#3").getTimeAfter(new DateTime(2012, 4, 20, 00, 00)), new DateTime(2012, 5, 18, 00, 00));
        assertEquals(new CronExpression("0 0 0 ? * 7#1").getTimeAfter(new DateTime(2012, 3, 30, 00, 00)), new DateTime(2012, 4, 7, 00, 00));
        assertEquals(new CronExpression("0 0 0 ? * 1#1").getTimeAfter(new DateTime(2012, 4, 1, 00, 00)), new DateTime(2012, 5, 6, 00, 00));
        assertEquals(new CronExpression("0 0 0 ? * 4#5").getTimeAfter(new DateTime(2012, 2, 6, 00, 00)), new DateTime(2012, 2, 29, 00, 00));
    }
